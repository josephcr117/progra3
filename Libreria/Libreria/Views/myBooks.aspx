...
<head runat="server">
    ...
    <title>My Books - Libreria Internacional</title>
                ...
                <ItemTemplate>
                    <div class="col">
                        <div class="card h-100">
                            <img src='<%# Eval("rutaFoto") %>' class="card-img-top" alt="Book Cover" />
                            <div class="card-body">
                                ...
                                <asp:Button ID="btnBuy" runat="server" Text="Buy Now" CssClass="btn btn-primary" OnClick="btnBuy_Click" CommandArgument='<%# Eval("ISBN") %>' />
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
